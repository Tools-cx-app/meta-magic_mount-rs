...
<template>
  ...
  >
    ...
    <div class="status-card__icon">
      <svg xmlns="http://www.w3.org/2000/svg" height="110px" width="110px" viewBox="0 -960 960 960" :fill="statusConfig[props.status].iconColor">
