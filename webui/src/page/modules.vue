...
import { MiuixSearchBar, MiuixCard,MiuixText, MiuixBasicComponent } from 'miuix-vue';
...
<template>
  <div class="page">
    ...
    <div v-else-if="moduleStore.modules.length === 0 || filterModules.length === 0" align="center">
      ...
      <div v-for="module in filterModules" :key="module.id">
        <MiuixCard class="ex-card">
          ...
          <Motion v-if="module.bottomopen" class="ex-expand"
            ...
            <MiuixBasicComponent :title="t('modules.descriptionLabel')" :summary="module.description" /> 
            <MiuixBasicComponent :title="t('modules.authorLabel')" :summary="module.author" /> 
          </Motion>
        </AnimatePresence>
        </MiuixCard>
      </div>
